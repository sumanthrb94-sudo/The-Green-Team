...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/analytics`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/preinvestor-gold`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
