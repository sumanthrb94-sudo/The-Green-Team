...
/**
 * Mobile conversion bar — replaces the old bottom navigation entirely.
 * Two actions, always in thumb reach: WhatsApp and the adviser call.
 */
...
export function StickyCTA() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-[9980] p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pointer-events-none">
      <div className="pointer-events-auto flex gap-2 p-1.5 rounded-full bg-[rgba(10,18,8,0.92)] backdrop-blur-xl border border-white/10 shadow-2xl">
        <a
          href={WHATSAPP.generic}
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-full border border-white/15 text-white/85 text-[10px] uppercase tracking-[0.25em] font-bold"
        >
