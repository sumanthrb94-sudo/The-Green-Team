...
const AGENDA: { label: string; sub: string; href: string }[] = [
  ...
  { label: 'Villas & Villaments', sub: 'A finished home, with the forest as the neighbour', href: '/explore/villas' },
  { label: 'Plots & Farmland', sub: 'Land you can stand on, at the forest edge', href: '/explore/plots' },
  { label: 'Investment Opportunities', sub: 'Appreciation with a paper trail — never a promise', href: '/explore/investments' },
